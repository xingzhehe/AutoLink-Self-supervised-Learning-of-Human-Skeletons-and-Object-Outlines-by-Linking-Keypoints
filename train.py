...
if __name__ == '__main__':
    ...
    # parser.add_argument('--data_root', type=str, default='../data/afhq')
    # parser.add_argument('--dataset', type=str, default='afhq')
    # parser.add_argument('--data_root', type=str, default='../data/h36m')
    # parser.add_argument('--dataset', type=str, default='h36m_wobg')
    # parser.add_argument('--data_root', type=str, default='../data/hand')
    # parser.add_argument('--dataset', type=str, default='hand')
    # parser.add_argument('--data_root', type=str, default='../data/deepfashion')
